...
public class BusinessSentenceSplitterBolt extends BaseRichBolt{
    ...
    public BusinessSentenceSplitterBolt(int minWordLength) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declare(new Fields("rawBusiness"));
    }
}
